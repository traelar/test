...
data class Payday(
    ...
    val payCalculator: PaycheckCalculatorSettings? = null
) {
...
data class AppData(
    ...
    val transactionTombstones: List<TransactionTombstone> = emptyList(),
    ...
    val financialSnapshots: List<FinancialSnapshot> = emptyList(),
