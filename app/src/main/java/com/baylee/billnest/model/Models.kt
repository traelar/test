...
data class AppData(
    ...
    val manualTransactions: List<FinanceTransaction> = emptyList(),
    val plaidTransactions: List<FinanceTransaction> = emptyList(),
    val budgets: List<Budget> = emptyList(),
    val debts: List<Debt> = emptyList(),
    val savingsGoals: List<SavingsGoal> = emptyList(),
    val reservedFunds: List<ReservedFund> = emptyList(),
    val billMatches: List<BillTransactionMatch> = emptyList(),
    val subscriptionOverrides: List<SubscriptionOverride> = emptyList(),
